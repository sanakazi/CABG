...
@Bind(R.id.age_current) TextView age_current; @Bind(R.id.age_future) TextView age_future;
    ...
    private void events()
    {
        ...
        severe_age.setText(String.valueOf( (chosen_age-age)+ " years")); days_added.setText(String.valueOf(daysAdded + " days"));
    ...
    protected void sendEmail() {
        ...
        emailIntent.putExtra(Intent.EXTRA_SUBJECT, "Edwards");
      //  emailIntent.putExtra(Intent.EXTRA_TEXT, "Email message goes here");
        ...
        try {
            ...
            Toast.makeText(Summary2Activity.this, "There is no email client installed.", Toast.LENGTH_SHORT).show();
        }
    }
